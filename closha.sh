...
function displayHelp() {
   ...
   echo "2. Run 'closha.sh' to backup all you've listed in the files"
   echo "3. Run 'closha.sh myBackup.12.bak' to restore a backup"
   echo ""
   echo "As for what a config file should look like, it's like this:"
   echo ""
   echo "output = ~/backups"
